...
<head>
    ...
    <title>Placement Status Update</title>
    <style>
        body {
...
<body>
    <div class="header">
        <h1>ORION AI</h1>
        <p>Placement Enrollment Status Update</p>
    </div>
    
    <div class="content">
        <h2>Hello,</h2>
        
        <p>Your placement enrollment status has been updated.</p>
        ...
        @elseif($newStatus == 'enrolled')
            <p>Congratulations! You have been enrolled in the placement preparation program. You will receive access details shortly.</p>
        @elseif($newStatus == 'completed')
            <p>Congratulations on completing the placement preparation program! We wish you all the best in your career.</p>
        @else
            <p>Your enrollment is currently being processed. We will update you soon.</p>
        @endif
